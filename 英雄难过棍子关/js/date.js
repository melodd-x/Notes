...
var infoData={
    ...
    "failDialog":function () {
        if (!$(".dialog").get(0)) {
            ...
            div.addClass("dialog");
            var p = $("<p></p >");
            p.html(infoData.fail[parseInt(Math.random() * (infoData.fail.length))]);
            div.append(p);
            p = $("<p></p >");
            ...
            var a = $("<a></a >");
            a.html("关闭");
            a.attr("class", "play-agin");
            a.attr("href", "index.html");
            p.append(a);
            a = $("<a></a >");
            a.html("重玩");
            a.attr("class", "play-agin");
            a.attr("href", "play.html");
            p.append(a);
            $(".container").after(div);
        } else {
            $(".dialog").show();
    ...
    "successDialog":function () {
        if(!$(".dialog").get(0)){
            ...
            div.addClass("dialog");
            var p=$("<p></p >");
            p.html(infoData.success[parseInt(Math.random()*(infoData.success.length))]);
            div.append(p);
            p=$("<p></p >");
            p.addClass("dialog-btn");
            div.append(p);
